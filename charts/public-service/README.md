...
| `affinity.enabled` | if true, k8s will try its best to create pods on different nodes. | `false` |
...
| `cloudSql.instanceConnectionName` | Cloud SQL instance connection name in the format `project:region:instance`. | `project:region:instance` |
